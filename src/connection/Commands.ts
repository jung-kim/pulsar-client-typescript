...
export const serializeBatch = (cmdSend: CommandSend, msgMetadata: MessageMetadata, uncompressedPayload: Uint8Array) => {
  // Wire format
...
export const getCommandPayload = (cmdSend: BaseCommand) => {
...
export const getMsMetadataPayload = (msgMetadata: MessageMetadata) => {
